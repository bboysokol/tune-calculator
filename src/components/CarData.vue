  ...
  <div class="col-12">
    ...
    <div class="col-12 d-flex flex-wrap">
      <div class="col-12 col-md-6 col-lg-4">
        <div>
          ...
          <el-checkbox-group v-model="engine" size="small" :max="1">
            <el-checkbox
              class="my-1 mx-1"
              v-for="item in availableMods.engine.slice(0, carInfo.engine)"
              :key="item.stage"
              :label="item.stage"
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <div>
          ...
          <el-checkbox-group v-model="brakes" size="small" :max="1">
            <el-checkbox
              class="my-1 mx-1"
              v-for="item in availableMods.brakes.slice(0, carInfo.brakes)"
              :key="item.stage"
              :label="item.stage"
              @change="(ev) => updateParts(ev, item)"
              border
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <div>
          Zawieszenie:
          <el-checkbox-group v-model="suspension" size="small" :max="1">
            <el-checkbox
              class="my-1 mx-1"
              v-for="item in availableMods.suspension.slice(0, carInfo.suspension)"
              :key="item.stage"
              :label="item.stage"
              @change="(ev) => updateParts(ev, item)"
              border
      ...
      <div class="col-12 col-md-6 col-lg-4">
        <div>
          Skrzynia biegów:
          <el-checkbox-group v-model="transmission" size="small" :max="1">
            <el-checkbox
              class="my-1 mx-1"
              v-for="item in availableMods.transmission.slice(0, carInfo.transmission)"
              :key="item.stage"
              :label="item.stage"
              @change="(ev) => updateParts(ev, item)"
              border
...
import { engine, turbo, suspension, brakes, transmission } from '../helpers/mechanicalParts';
export default {
  data() {
    return {
      availableMods: {
